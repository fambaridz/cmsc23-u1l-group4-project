...
class DonationListProvider with ChangeNotifier {
  ...
  Future<Map<String, dynamic>> getDonation(String id) async {
    var donationData = await firebaseService.getDonation(id);
    notifyListeners();
    return donationData;
  }
  ...
  Future<List<Map<String, dynamic>?>> getDonationsByOrgId(String oid) async {
    List<Map<String, dynamic>?> message =
        await firebaseService.getDonationsByOrgId(oid);
    notifyListeners();
    return message;
  }
  ...
  Future<List<Map<String, dynamic>>?> getUnsortedDonationsByOrgId(
      String oid) async {
    List<Map<String, dynamic>>? message =
        await firebaseService.getUnsortedDonationsByOrgId(oid);
    notifyListeners();
    return message;
  }
