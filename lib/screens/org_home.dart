...
class _OrganizationHomePageState extends State<OrganizationHomePage> {
  final statusMap = {
    ...
    2: {
      "text": "CONFIRMED", 
      "color": Color.fromARGB(255, 247, 206, 70)
      },
    3: {
      "text": "FOR\n PICK-UP", 
      "color": Color.fromARGB(255, 147, 217, 78)
      },
    4: {
      "text": "COMPLETED", 
      "color": Colors.green
    ...
    5: {
      "text": "CANCELLED", 
      "color": Color.fromARGB(255, 215, 63, 63)
      },
  };
    ...
    return Scaffold(
      ...
      body: Center(
        child: donationList.isEmpty
          ...
          children: donationList.map((donation) => GestureDetector(
            onTap: () {
